...
import { bookPath, newBookPath, wishlistPath, editBookPath, bunchDeletePath } from '../helpers/routes';
import Wishlist from '../Book/Wishlist';
import NewBook from '../Pages/NewBook';
import EditBook from '../Pages/EditBook';
import BunchDelete from '../Pages/BunchDelete';

const AppRoutes = () => (
  <Switch>
    <Route component={List} path="/" exact />
    <Route component={NewBook} path={newBookPath()} strict exact />
    <Route component={BunchDelete} path={bunchDeletePath()} strict exact />
