...
const PriceInput = (props) => {
  const { minimalPrice, label, commission, price, setPrice } = props;
  ...
  return (
    <p>
      <label> {label} </label>
      <input style={styles.inputField} value={priceAfterCommission} onChange={setPrice} data-commission={commission} />
